    ...
    if (!abcd) {
                            ...
                            if ($(this).index() == 4) {
                                ...
                                if ($(this).index() == 5) {
                                    ...
                                    if ($(this).index() == 7) {
                                        ...
                                        window.location = "./letter_clip.html"
                                    }
                                }
                            }
                        }
        ...
        function bindHTML(d) {
            ...
            $(".oppen").on("click", function (event) {
                  var TM= $(this).parent().parent().parent().attr("infor");
                  for(var n=0;n<data.length;n++){
                      if(data[n].dataId== TM){
                        window.name=data[n].dataId;
                      }
                  }
            ...
            for (var n = 0; n < arr.length; n++) {
                ...
                for (var i = 0; i < this.length; i++) {
                    if (clearSpace(curD.species).indexOf(clearSpace(this[i])) !== -1) {
                        ...
                        if (clearSpace(curD.country) == clearSpace(this[i])) {
                            _arr.push(curD)
                        } else {
                            if (clearSpace(curD.stand).indexOf(clearSpace(this[i])) !== -1) {
                                _arr.push(curD)
                            } else {
                                if (clearSpace(curD.purpose).indexOf(clearSpace(this[i])) !== -1) {
                                    _arr.push(curD)
                                }
                            }
                        }
        ...
        function bindPages(s) {
            ...
            for (var m = 0; m < data.length; m++) {
                if (regStr.test(data[m].name) && aryP.indexOf(data[m]) === -1) {
                    ...
                    if (regStr.test(data[m].country) && aryP.indexOf(data[m]) === -1) {
                        aryP.push(data[m])
                    } else {
                        if (regStr.test(data[m].stand) && aryP.indexOf(data[m]) === -1) {
                            aryP.push(data[m])
                        } else {
                            if (regStr.test(data[m].species) && aryP.indexOf(data[m]) === -1) {
                                aryP.push(data[m])
                            } else {
                                if (regStr.test(data[m].avocation) && aryP.indexOf(data[m]) === -1) {
                                    aryP.push(data[m])
                                }
                            }
                        }
